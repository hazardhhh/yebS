...
import com.hhh.server.pojo.MailConstants;
...
public class RabbitMQConfig {
  ...
  @Autowired private IMailLogService mailLogService;
  ...
  public RabbitTemplate rabbitTemplate() {
    ...
    /** 消息失败回调，比如router不到queue时回调 msg：消息主题 repCode：响应码 repText：相应描述 exchange：交换机 routingKey：路由键 */
