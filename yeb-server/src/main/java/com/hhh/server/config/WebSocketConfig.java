...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
  ...
  /**
   * 添加这个Endpoint，这样在网页可以通过websocket连接上服务,也就是我们配置websocket的服务地址，并且可以指定是否使用socketJS
   *
   * @param registry
   */
  @Override
  public void registerStompEndpoints(StompEndpointRegistry registry) {
    /**
     * 1.将ws/ep路径注册为stomp的端点，用户连接了这个端点就可以进行 websocket通讯，支持socketJS 2.setAllowedOrigins("*")：允许跨域
